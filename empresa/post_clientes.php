...
$sql2 = "INSERT INTO clientes(cedula,nombre,telefono,estado)VALUES ('$cedula','$nombre','$telefono','1')";
if (mysqli_query($conexion, $sql2)) {
	// Imprimimos que se ingreso correctamente
	 echo "<script>alert('se ha registrado el nuevo Cliente con exito');window.location='clientes.php'</script>";
} else {
