...
<nav style="width: 100%;" class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<ul class="navbar-nav ml-auto">
		<form   id="form2" class="form-inline my-2 my-lg-0">
			<input style=" margin: 0;border-radius: .25rem; background: white; width:64% ;height: 2.4rem;" type="search" id="searchp" class="form-control mr-sm-2" placeholder="Buscar Producto..." name="busqueda2">
			<ul id="response2"></ul>
